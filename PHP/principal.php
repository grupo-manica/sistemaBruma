...
<main style="padding: 1rem;">
  <section style="text-align:center; margin-bottom: 1.5rem;">
    ...
    <p>Você entrou como <strong><?= $role ?></strong> (login: <?= $login ?>)</p>
  </section>
  ...
  <?php elseif ($role === 'profissional'): ?>
    <section>
      <h2>Área do Profissional</h2>
      <p>Aqui você pode gerenciar sua agenda, receber solicitações e atualizar seu perfil.</p>
      <!-- conteúdo específico de profissional -->
    </section>
  <?php else: ?>
    <section>
